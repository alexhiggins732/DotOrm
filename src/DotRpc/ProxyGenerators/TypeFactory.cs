...
namespace DotRpc
{
    ...
    {
        public static Type GetMethodProxyType(MethodInfo method)
        {
    ...
    public static class ProxyGenerator
    {
        ...
        private static readonly LockingConcurrentDictionary<MethodTypeDescription, Type> MethodProxyTypes = new(EmitMethodProxy);
        private static readonly LockingConcurrentDictionary<MethodTypeDescription, Type> ClientProxyTypes = new(EmitClientProxy);
        private static readonly LockingConcurrentDictionary<MethodTypeDescription, Type> ServerProxyTypes = new(EmitServerProxy);
        private static ModuleBuilder CreateProxyModule()
        {
            var assemblyName = typeof(TypeFactory).Assembly.GetName();
        ...
        private static Type EmitClientProxy(MethodTypeDescription typeDescription)
        {
        ...
        private static Type EmitServerProxy(MethodTypeDescription typeDescription)
        {
            var typeBuilder = GenerateType(typeDescription);
            GenerateConstructor(typeBuilder);
            return typeBuilder.CreateTypeInfo().AsType();
        }
        private static Type EmitMethodProxy(MethodTypeDescription typeDescription)
        {
            ...
            Dictionary<string, PropertyEmitter> GenerateProperties()
            {
                ...
                foreach (var property in PropertiesToImplement())
                {
                    ...
                    else
                    {
                        ...
                        fieldBuilders.Add(property.Name, new PropertyEmitter(typeBuilder, parameterProperty, null, atts));
            ...
            IEnumerable<Type>? implementedInterfaceTypes = null)
        {
            ...
            typeName = NameService.GenerateTypeName(typeDescription);
        ...
        public static Type GetProxyType(MethodInfo methodInfo) => MethodProxyTypes.GetOrAdd(new(methodInfo));
